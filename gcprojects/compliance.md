...
Multiple controls need to be implemented to improve Botium Toys’ security posture is very poor, and it needs to be updated promptly the company needs to promptly make updates on their least privilege, password management systems, implement IDS, secure customers and employee’s data. In addition, they need to create a disaster recovery plan.
